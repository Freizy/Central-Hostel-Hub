        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="roombook.php"><i class="fa fa-bar-chart-o"></i> Hostel Booking</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Status <small>Hostel Room Booking </small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                                            ...
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                                    <button class="btn btn-default" type="button">
                                                        New Hostel Room Bookings <span class="badge"><?php echo $c; ?></span>
                                                    </button>
                                                </a>
                                            </h4>
                                        </div>
                                            ...
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" class="collapsed">
                                                    <button class="btn btn-primary" type="button">
                                                        Booked Hostels <span class="badge"><?php echo $r; ?></span>
                                                    </button>
