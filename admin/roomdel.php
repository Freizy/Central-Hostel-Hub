		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li>
						<a href="settings.php"><i class="fa fa-dashboard"></i>Hostel Room Status</a>
					</li>
					<li>
						<a href="room.php"><i class="fa fa-plus-circle"></i>Add Hostel</a>
					</li>
					<li>
						<a class="active-menu" href="roomdel.php"><i class="fa fa-pencil-square-o"></i> Delete Hostel</a>
					</li>
				...
				<div class="row">
					...
					<div class="row">
						...
						while ($row = mysqli_fetch_array($re)) {
							...
							if ($id == "Queens Court") {
							...
							} else if ($id == "Pramheart") {
								echo "<div class='col-md-3 col-sm-12 col-xs-12'>
													<div class='panel panel-primary text-center no-boder bg-color-violet'>
														<div class='panel-body'>
															<i class='fa fa-users fa-5x'></i>
															<h3>" . $row['bedding'] . "</h3>
														</div>
								...
								echo "<div class='col-md-3 col-sm-12 col-xs-12'>
													<div class='panel panel-primary text-center no-boder bg-color-gold'>
														<div class='panel-body'>
															<i class='fa fa-users fa-5x'></i>
															<h3>" . $row['bedding'] . "</h3>
														</div>
														<div class='panel-footer back-footer-gold'>
															" . $row['type'] . "
								...
								echo "<div class='col-md-3 col-sm-12 col-xs-12'>
													<div class='panel panel-primary text-center no-boder bg-color-indigo'>
														<div class='panel-body'>
															<i class='fa fa-users fa-5x'></i>
															<h3>" . $row['bedding'] . "</h3>
														</div>
														<div class='panel-footer back-footer-indigo'>
															" . $row['type'] . "
